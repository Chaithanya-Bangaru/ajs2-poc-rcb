System.register(['angular2/core', '../shared/star.component', 'angular2/router', './product.service'], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, star_component_1, router_1, product_service_1;
        ...
        execute: function() {
            ProductDetailComponent = (function () {
                function ProductDetailComponent(_routeParams, _router, _productService) {
                    ...
                    var id = +this._routeParams.get('id'); // let is block scoped variable introduced in ES 2015        
                    this.pageTitle += " " + id;
                }
                ...
                ProductDetailComponent.prototype.onHome = function () {
